...
export default function Nav () {
  ...
  return (
    <header className={darkMode ? "dark" : ""}>
      ...
      >
        <a href='#home' className="block bg-gradient-to-r from-cyan-500 to-teal-500 text-white text-sm p-1 border-none rounded-md" >Home</a>
        <a href='#work' className="block bg-gradient-to-r from-cyan-500 to-teal-500 text-white text-sm p-1 border-none rounded-md">My work</a>
        <a href='#hire' className="block bg-gradient-to-r from-cyan-500 to-teal-500 text-white text-sm p-1 border-none rounded-md"> 
