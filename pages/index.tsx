        ...
        <section className="py-10">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 ">
              <a href='https://cs-e-commerce.netlify.app/'>
                <Image
            ...
            <div className="basis-1/3 flex-1">
              <a href='https://smart-brain--frontend.herokuapp.com/'>
              <Image
                className="rounded-lg object-cover"
                layout="responsive"
                src={web2}
            ...
            <div className="basis-1/3 flex-1">
              <a href='https://63993dab88e78b6f91c08ddc--super-figolla-c0c901.netlify.app/'>
              <Image
                className="rounded-lg object-cover"
                layout="responsive"
                src={web4}
            ...
            <div className="basis-1/3 flex-1">
              <a href='https://react-app-soccer.netlify.app/'>
              <Image
                className="rounded-lg object-cover"
                layout="responsive"
                src={web5}
